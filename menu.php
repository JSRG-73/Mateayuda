        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="card card-blog">
              ...
              <div class="card-img">
                <a href="Juegos/Numero misterioso/NM_sum.php"><img src="assets/img/TN/TNNmisteriossoSum.png" alt="" class="img-fluid"></a>
              </div>
              <div class="card-body">
                <div class="card-category-box">
                  <div class="card-category">
                    <h6 class="category">Número misterioso</h6>
                  </div>
                </div>
          ...
          <div class="col-md-4">
            <div class="card card-blog">
              ...
              <div class="card-img">
                <a href="Juegos/Numero misterioso/NM_res.php"><img src="assets/img/TN/TNNmisteriossoRes.png" alt="" class="img-fluid"></a>
              </div>
              <div class="card-body">
                <div class="card-category-box">
                  <div class="card-category">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card card-blog">
              ...
              <div class="card-img">
                <a href="Juegos/Numero misterioso/NM_mul.php"><img src="assets/img/TN/TNNmisteriossomul.png" alt="" class="img-fluid"></a>
              </div>
              <div class="card-body">
                <div class="card-category-box">
                  <div class="card-category">
                    <h6 class="category">Número misterio</h6>
                  </div>
                </div>
          ...
          <div class="col-md-4">
            <div class="card card-blog">
              ...
              <div class="card-img">
                <a href="Juegos/Numero misterioso/NM_div.php"><img src="assets/img/TN/BGNmisteriossoDiv.png" alt="" class="img-fluid"></a>
              </div>
              <div class="card-body">
                <div class="card-category-box">
                  <div class="card-category">
          ...
          <div class="col-md-4">
            <div class="card card-blog">
              ...
              <div class="card-body">
                <div class="card-category-box">
                  <div class="card-category">
                    <h6 class="category">Números revueltos</h6>
                  </div>
                </div>
          ...
          <div class="col-md-4">
            <div class="card card-blog">
              ...
              <div class="card-body">
                ...
                <p class="card-description">
                  Resuelve las divisiones y ordena las fichas de menor a mayor.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="contact-mf">
              <div id="contact" class="box-shadow-full">
                <p>Este es un software educativo con la finalidad de ayudar a los niños a aprender matemáticas jugando</p>
              </div>
            </div>
          </div>
        </div>
